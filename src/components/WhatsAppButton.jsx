...
const WhatsAppButton = () => {
  ...
  return createPortal(
    <div className="fixed bottom-6 right-6 z-[9999] flex items-center gap-2">
      ...
      {/* 🟢 Burbuja de texto */}
      {showBubble && (
        <div className="bg-white text-gray-800 px-4 py-2 rounded-xl shadow-lg border border-gray-200 text-sm font-medium animate-fadeIn">
          ¿Necesitas cotizar?
        </div>
      )}
      ...
      {/* ✅ Botón WhatsApp */}
      <a
        href="https://wa.me/573138547852?text=Hola%2C+quiero+cotizar+un+servicio"
        target="_blank"
