          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-[#f6fbfb]/80">+57 300 123 4567</span>
              </div>
              <div className="flex items-center space-x-3">
                <Mail className="h-4 w-4 text-[#77c3cf]" />
                <span className="text-[#f6fbfb]/80">info@estrumec.com</span>
              </div>
              <div className="flex items-center space-x-3">
                <MapPin className="h-4 w-4 text-[#77c3cf]" />
                <span className="text-[#f6fbfb]/80">Bogotá, Colombia</span>
              </div>
            </div>
          </div>
